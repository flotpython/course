...
# Pour les **fonctions** qui permettent de créer un tableau numpy
# comme la **fonction** ones qui permet de créer un tableau
# contenant des 1,
...
# cela. Utilisons la **fonction** ones pour créer un
...
# c'est pourquoi on a des **fonctions** ones et zeros pour
...
# Créons un tableau numpy avec la **fonction** array qui sert à
